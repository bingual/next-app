                ...
                <div className="mb-6">
                    ...
                    <input
                        {...register('title', {
                            required: {
                                value: true,
                                message: '제목은 필수 입력 사항 입니다.',
                            },
                            minLength: {
                                value: 3,
                                message: '제목은 3글자 이상 입력 해주세요.',
                            },
                            pattern: {
                                value: /\S/g,
                                message: '공백만은 허용 되지않습니다.',
                            },
                        })}
                        type="text"
                        id="default-input"
                        placeholder={'제목을 입력해주세요.'}
                        className="focus:outline-none bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500  block w-full p-2.5 px-4 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 "
                    />
                </div>
